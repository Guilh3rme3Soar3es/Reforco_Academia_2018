...
GO
PRINT N'Alterando [dbo].[TBEvento]...';


GO
ALTER TABLE [dbo].[TBEvento] ALTER COLUMN [data_inicio] DATETIME NOT NULL;

ALTER TABLE [dbo].[TBEvento] ALTER COLUMN [data_termino] DATETIME NOT NULL;
