...
CREATE TABLE [dbo].[TBBook] (
    ...
    CONSTRAINT [PK_Books] PRIMARY KEY CLUSTERED ([IdBook] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Criando [dbo].[TBLoan]...';
...
CREATE TABLE [dbo].[TBLoan] (
    ...
    [BookId]         INT           NULL,
    CONSTRAINT [PK_Loan] PRIMARY KEY CLUSTERED ([IdLoan] ASC) ON [PRIMARY]
) ON [PRIMARY];
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'bf323dcf-e530-4c33-bcc8-a69e82c2f65b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('bf323dcf-e530-4c33-bcc8-a69e82c2f65b')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ab0e32c8-dafc-48d5-9e9d-180861ccb64a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ab0e32c8-dafc-48d5-9e9d-180861ccb64a')
